...
<TD WIDTH=100% height=5><font color=$ELE_C[$xele] size=4><center>-<B> $xname국 회의실</B>-</font></TR></TD>
</TR><TR>
<TD height=5>
...
<input type=hidden name=mode value=COUNTRY_W>
...
EOM
  ...
  <TBODY>
    <TR>
      <TD colspan=3 bgcolor=$ELE_BG[$xele]><B><font size=3 color=$ELE_C[$bbele]>제목 : $bbtitle</font></B></TD>
    </TR>
    <TR>
